    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          ...
          >
            <IconArrowNarrowLeft className="h-6 w-6 text-off-red" />
          </button>
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full border-1 border-gray-600/50 disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <IconArrowNarrowRight className="h-6 w-6 text-off-red" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 h-full w-full bg-main backdrop-blur-lg"
            />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
